      ...
      <div>
        ...
        <div className="policyBox">
          <div className="policyHeaderBox">
            <h1 className="policyHeading">Terms of Service</h1>
          </div>
        </div>
        <div className="policyDataBox1">
          <p className="policyTxt">OVERVIEW </p>
          <p>
            Toonized offers this website, including all information, tools and
            ...
            e-commerce platform that allows us our products and services to you.
            <br />
            <br />
            <p>
              <b> Refund Policy for drawing (digital copy) orders</b>
              <br />
              Toonized.com, we do not accept refunds for drawings that are
              either being processed or have already been completed. However,
              customers do have the right to unlimited revisions and can request
              that their drawings are revised until they are satisfied with the
              result.
            </p>
          </p>
        </div>
        ...
        <div className="policyDataBox1">
          <p className="policyTxt">SECTION 1 - ONLINE STORE TERMS</p>
          <p>
        ...
        <div className="policyDataBox1">
          <p className="policyTxt">SECTION 2 - GENERAL CONDITIONS</p>
          <p>
        ...
        <div className="policyDataBox1">
          <p className="policyTxt">SECTION 7 - OPTIONAL TOOLS</p>
          <p>
        ...
        <div className="policyDataBox1">
          <p className="policyTxt">SECTION 8 - THIRD-PARTY LINKS</p>
          <p>
        ...
        <div className="policyDataBox1">
          <p className="policyTxt">SECTION 10 - PERSONAL INFORMATION</p>
          <p>
        ...
        <div className="policyDataBox1">
          <p className="policyTxt">SECTION 12 - PROHIBITED USES</p>
          <p>
        ...
        <div className="policyDataBox1">
          ...
          <p>
            ...
            conditions of merchantability, merchantable quality, You expressly
        ...
        <div className="policyDataBox1">
          <p className="policyTxt">SECTION 14 - INDEMNIFICATION</p>
          <p>
            You agree to indemnify, defend and hold harmless 1two6Store and our
        ...
        <div className="policyDataBox1">
          <p className="policyTxt">SECTION 15 - SEVERABILITY</p>
          <p>
        ...
        <div className="policyDataBox1">
          <p className="policyTxt">SECTION 16 - TERMINATION</p>
          <p>
        ...
        <div className="policyDataBox1">
          <p className="policyTxt">SECTION 17 - ENTIRE AGREEMENT</p>
          <p>
        ...
        <div className="policyDataBox1">
          <p className="policyTxt">SECTION 18 - GOVERNING LAW</p>
          <p>
        ...
        <div className="policyDataBox1">
          <p className="policyTxt">SECTION 19 - CHANGES TO TERMS OF SERVICE</p>
          <p>
        ...
        <div className="policyDataBox1">
          <p className="policyTxt">SECTION 20 - CONTACT INFORMATION</p>
          <p>
        ...
        <div className="tableBox">
          ...
          <img alt="" src={table} className="paintTable" />
          <img alt="" src={center} className="centerTable" />
          <h1 className="paintTxt">Beautiful works loading...</h1>
